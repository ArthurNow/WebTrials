...
export default function Snail() {
  return (
    <svg id="snail" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496.07 269.85">
      <defs>
        <style>
          {`
            .cls-1 {
